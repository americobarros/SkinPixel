      ...
      <Router>
        <div>
          ...
          <Switch>
            ...
            <Route exact path="/skin/:skinId" children={<ViewSkin allSkins={allSkins} allUsers={allUsers} currUser={currUser} />}/>
            <Route exact path="/skin/edit/:skinId" children={<EditSkin handleSnackbarClick={handleSnackbarClick}
                                                                       currUser={currUser} />}/>
            <Route exact path="/newskin" children={<EditSkin handleSnackbarClick={handleSnackbarClick}
                                                                       currUser={currUser} />}/>
            <Route exact path="/newresource" children={<EditTexture allResourcePacks={allResourcePacks} handleSnackbarClick={handleSnackbarClick}
                                                                       currUser={currUser} />}/>
            <Route exact path="/newmap" children={<EditMap allMaps={allMaps} handleSnackbarClick={handleSnackbarClick}
                                                                       currUser={currUser} />}/>
